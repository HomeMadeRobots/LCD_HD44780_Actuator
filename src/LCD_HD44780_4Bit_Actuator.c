...
/*============================================================================*/
static void Write_4_Bits_Data(
    const LCD_HD44780_4Bit_Actuator* Me,
    uint8_t bits );
static void Write_Data( const LCD_HD44780_4Bit_Actuator* Me, uint8_t data );
static void Send_Command( 
    const LCD_HD44780_4Bit_Actuator* Me,
    uint8_t command );
static void Send_Character(
    const LCD_HD44780_4Bit_Actuator* Me,
    uint8_t character );
static void Perform_Pulse_On_Enable_Pin( const LCD_HD44780_4Bit_Actuator* Me );


/*============================================================================*/
/* Component_Operations */
/*============================================================================*/
void LCD4BDAct__Initialize( const LCD_HD44780_4Bit_Actuator* Me )
{
...
/*----------------------------------------------------------------------------*/
void LCD4BDAct__Commands__Hide_Cursor( const LCD_HD44780_4Bit_Actuator* Me )
{
    Reset_Bit_Uint8( My_Display_Settings_Cmd, CURSOR_SETTING_BIT );
    Send_Command( Me, My_Display_Settings_Cmd );
}
/*----------------------------------------------------------------------------*/
void LCD4BDAct__Commands__Show_Cursor( const LCD_HD44780_4Bit_Actuator* Me )
{
    Set_Bit_Uint8( My_Display_Settings_Cmd, CURSOR_SETTING_BIT );
    Send_Command( Me, My_Display_Settings_Cmd );
}
/*----------------------------------------------------------------------------*/
void LCD4BDAct__Commands__Blink_Cursor( const LCD_HD44780_4Bit_Actuator* Me )
{
    Set_Bit_Uint8( My_Display_Settings_Cmd, BLINK_SETTING_BIT );
    Send_Command( Me, My_Display_Settings_Cmd );
}
/*----------------------------------------------------------------------------*/
void LCD4BDAct__Commands__No_Blink_Cursor( const LCD_HD44780_4Bit_Actuator* Me )
{
    Reset_Bit_Uint8( My_Display_Settings_Cmd, BLINK_SETTING_BIT );
    Send_Command( Me, My_Display_Settings_Cmd );
}
/*----------------------------------------------------------------------------*/
void LCD4BDAct__Commands__Hide_Text( const LCD_HD44780_4Bit_Actuator* Me )
{
    Reset_Bit_Uint8( My_Display_Settings_Cmd, DISPLAY_SETTING_BIT );
    Send_Command( Me, My_Display_Settings_Cmd );
}
/*----------------------------------------------------------------------------*/
void LCD4BDAct__Commands__Show_Text( const LCD_HD44780_4Bit_Actuator* Me )
{
    Set_Bit_Uint8( My_Display_Settings_Cmd, DISPLAY_SETTING_BIT );
    Send_Command( Me, My_Display_Settings_Cmd );
}
/*----------------------------------------------------------------------------*/
void LCD4BDAct__Commands__Clear_Text( const LCD_HD44780_4Bit_Actuator* Me )
{
...
/*----------------------------------------------------------------------------*/
static void Send_Command( const LCD_HD44780_4Bit_Actuator* Me, uint8_t command )
{
    Me->Register_Select_Pin->Set_Level( IO_LEVEL_LOW );
